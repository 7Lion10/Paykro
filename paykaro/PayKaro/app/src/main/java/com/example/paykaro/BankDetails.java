...
public class BankDetails extends AppCompatActivity {
    ...
    private EditText accountHolderName, bankName, accountNumber, panNumber, aadharNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bankNameSpinner = findViewById(R.id.bankname_spinner);  // Initialize Spinner instead of EditText
        accountNumber = findViewById(R.id.Anumber);
        panNumber = findViewById(R.id.panno);
        aadharNumber = findViewById(R.id.Adharno);
        signUpButton = findViewById(R.id.signup);
// Set up the bank name spinner with a list of bank names
        String[] bankNames = {
        ...
        signUpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String bank = bankNameSpinner.getSelectedItem().toString();  // Get selected bank from spinner
                ...
                .addOnCompleteListener(this, task -> {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        if (user != null) {
                            ...
                            User_Database newUser = new User_Database(username, email, phoneNumber, accountName, bank, accountNum, pan, aadhar);
    ...
    private boolean validateBankDetails(String accountName, String bank, String accountNum, String pan, String aadhar) {
        ...
        if (bank.equals("Select Bank")) {  // Check if "Select Bank" is chosen
