...
public class MobileTransfer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goToContacts.setOnClickListener(v -> {
            Intent intent = new Intent(MobileTransfer.this, ShowContacts.class);
        ...
        listViewContacts.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(MobileTransfer.this, enterAmount.class);
    ...
    private void fetchContacts() {
        contactsRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(MobileTransfer.this, "Error fetching contacts", Toast.LENGTH_SHORT).show();
                Log.e("MobileTransfer", "Database error: " + databaseError.getMessage());
            }
        });
    }
