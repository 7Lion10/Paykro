...
public class recharge_by_contact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recharge_by_contact);
        ...
        listViewContacts.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, android.view.View view, int position, long id) {
                ...
                Intent intent = new Intent(recharge_by_contact.this, ServiceProviderRecharge.class);
    ...
    private void fetchContacts() {
        contactsRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(recharge_by_contact.this, "Error fetching contacts", Toast.LENGTH_SHORT).show();
